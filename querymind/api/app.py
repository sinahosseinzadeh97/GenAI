...
from querymind.api.middleware.auth import api_key_middleware
from querymind.logging_config import setup_logging, StructuredLogger
from slowapi import _rate_limit_exceeded_handler
from slowapi.errors import RateLimitExceeded
from querymind.api.middleware.rate_limit import limiter, rate_limit_exceeded_handler, QUERY_LIMIT
...
async def query_endpoint(request: Request, req: QueryAPIRequest):
    """
...
async def get_history():
    return {
        "turns": [t.model_dump() for t in await _memory.get_turns()]
    }
